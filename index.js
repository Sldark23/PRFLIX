...
o serviço mais profissional.  Caso deseje, pode contratar consultoria pelo telegram samucamg ou email samucamg@gmail.com */
...
const serviceaccounts = [
{
  ...
  "project_id": "gabypng",
  "private_key_id": "ca5880093505675cb212540cdce7c2413c8f1c4f",
  "private_key": "-----BEGIN PRIVATE KEY-----\\na6e0AzKOuZ70Sm/ggyRncNOs\n-----END PRIVATE KEY-----\n",
  "client_email": "prtube@gabypng.iam.gserviceaccount.com",
  "client_id": "117092721448480610282",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/prtube%40gabypng.iam.gserviceaccount.com",
  "universe_domain": "googleapis.com"
}

];
const randomserviceaccount = serviceaccounts[Math.floor(Math.random()*serviceaccounts.length)]; // Não coloque a mão nisso
const domains_for_dl = ['']; // Incluir vários cloudflares exemplo. ['https://samucatutoriais1.workers.dev', 'https://samucatutoriais2.workers.dev']
...
const video_domains_for_dl = ['']; // Incluir vários cloudflares para balancear o download. ['https://samucatutoriais1.workers.dev', 'https://samucatutoriais2.workers.dev']
...
const authConfig = {
    "siteName": "PRFLIX", // Nome do seu site
    ...
    "roots":[
        {
          "id": "15rGgjG15Lh9DXXyng5o1Odk-eHZmjQ6v",
          "name": "PRFLIX",
          "protect_file_link": false,
//"auth": {} /* Remove double slash before "auth" to activate id password protection */
      },
...
const uiConfig = {
    "theme": "slate", /* Caso queira, alterne entre um dos temas a seguir cerulean, cosmo, cyborg, darkly, flatly, journal, litera, lumen, lux, materia, minty, pulse, sandstone, simplex, sketchy, slate, solar, spacelab, superhero, united, yeti, vapor, morph, quartz, zephyr */
...
"logo_image": true, // true se você estiver usando o link da imagem na próxima opção.
    ...
    "logo_width": "50px", // somente se logo_image for true valor em px
    "favicon": "https://cdn.discordapp.com/attachments/1150312401401557074/1225168764362817686/image5.png?ex=66202653&is=660db153&hm=9571a4a44f084e41235e48e08900f63e4f2c3823a4a1af6f27fcb384071cfd3b&",
    // se o logotipo for verdadeiro, coloque a URL da imagem, caso contrário, coloque apenas um texto
    "logo_link_name": "https://cdn.discordapp.com/attachments/1150312401401557074/1225168764362817686/image5.png?ex=66202653&is=660db153&hm=9571a4a44f084e41235e48e08900f63e4f2c3823a4a1af6f27fcb384071cfd3b&",
    "fixed_header": true, // Se você deseja que o rodapé seja flexível ou fixo..
    "header_padding": "80", // Valor 80 para cabeçalho fixo, Valor 20 para cabeçalho flexível. Em alguns temas poderá ser necessário alterar.
    ...
    "footer_style_class": "bg-primary", // Caso queira, altere para uma das opções a seguir: bg-primary || bg-dark || bg-light
    "css_a_tag_color": "white", // Nome da cor (em inglês) ou código hexadecimal, por exemplo.. #ffffff
    "css_p_tag_color": "white", // Nome da cor ou código hexadecimal, por exemplo. #ffffff
    "folder_text_color": "white", // Nome da cor ou código hexadecimal, por exemplo. #ffffff
    ...
    "contact_link": "https://t.me/samucamg", // Link para o botão de contato no menu
    "copyright_year": "2022", // Ano para copyright, pode ser tipo 2015 - 2020 ou apenas 2020
    "company_name": "Samuca Tutoriais", // Nome ao lado dos direitos autorais
    "company_link": "https://t.me/samucamg", // link do nome dos direitos autorais
    ...
    "poster": "https://i.imgur.com/Lhyhckt.png", // Poster para vídeos, altere para um de sua preferencia, ou dê crédito ao Samuca
    ...
    "unauthorized_owner_link": "https://t.me/samucamg", // Link de página de erro não autorizado para o proprietário
    "unauthorized_owner_email": "abuse@telegram.org", // E-mail não autorizado do proprietário da página de erro
};
